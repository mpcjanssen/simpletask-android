...
namespace eval tcl {
    variable Dir
    # jtcl - remove, don't include parent of resource path
    # if {[info library] ne ""} {
...
# jtcl - remove windows specific code
...
# jtcl - hacky handling for java
if {$tcl_platform(platform) eq "java"} {

proc auto_execok name {
    # if name looks like a history "!" command, return null string
    # otherwise, assume it is a system command.
