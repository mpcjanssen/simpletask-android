    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        btnTest.setOnClickListener {
            ...
            try {
                ...
                // FIXME: pass createIsThreshold boolean in here instead of 'true'
                if (script.trim { it <= ' ' }.isEmpty() || LuaInterpreter.evalScript(environment, script)
                                                                          .onFilterCallback(environment,t,true)) {
