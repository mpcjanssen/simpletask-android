...
class PreferencesActivity : ThemedPreferenceActivity(), SharedPreferences.OnSharedPreferenceChangeListener {

    lateinit var prefs: SharedPreferences
    lateinit var app: SimpletaskApplication
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        app = application as SimpletaskApplication
    ...
    class DonatePrefFragment : PrefFragment(R.xml.donate_preferences) {
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            val app = activity.application as SimpletaskApplication
            if (app.hasDonated()) {
    ...
    companion object {
        internal val TAG = PreferencesActivity::class.java.simpleName
    }
}
