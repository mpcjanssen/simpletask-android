...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        todoListStatusDaoConfig = daoConfigMap.get(TodoListStatusDao.class).clone();
        todoListStatusDaoConfig.initIdentityScope(type);
    ...
    public void clear() {
        ...
        todoListStatusDaoConfig.getIdentityScope().clear();
    }
    ...
    public TodoListStatusDao getTodoListStatusDao() {
        return todoListStatusDao;
    }
