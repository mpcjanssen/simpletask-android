...
Well no actually. Even though this is not a clearly articulated in the original
...
be anything from a projectname to a persons name. This allows using tasks like:
