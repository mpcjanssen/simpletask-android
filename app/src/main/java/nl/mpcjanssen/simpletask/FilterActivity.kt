...
class FilterActivity : ThemedNoActionBarActivity() {
    ...
    companion object {
        ...
        val PRIO_TAB = R.string.filter_tab_header_prio
        val OTHER_TAB = R.string.filter_tab_header_other
        val SORT_TAB = R.string.filter_tab_header_sort
        val SCRIPT_TAB = R.string.filter_tab_header_script
