...
class FilterActivity : ThemedNoActionBarActivity() {
    ...
    private var asWidgetConfigure = false
    private var asWidgetReConfigure = false
    private lateinit var mFilter: Query

    private lateinit var m_app: TodoApplication
    private val prefs = TodoApplication.config.prefs
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.i(TAG, "Called with intent: $intent")
    ...
    private inner class ScreenSlidePagerAdapter(fm: FragmentManager) : FragmentStatePagerAdapter(fm) {
        ...
        override fun getPageTitle(position: Int): CharSequence {
            ...
            return when (val type = f.arguments?.getString(TAB_TYPE, "unknown") ?:"unknown") {
    ...
    companion object {
        ...
        const val INITIAL_SELECTED_ITEMS = "initialSelectedItems"
